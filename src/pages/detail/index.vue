    ...
    <div class="allContent">
      <div class="left">
        <div class="left-top">
          <div class="header-content">
            ...
            <ul>
              ...
              <li v-if="content.tab == 'share'">来自分享</li>
              <li v-if="content.tab == 'ask'">来自问答</li>
              <li v-if="content.tab == 'job'">来自招聘</li>
            </ul>
        ...
        <div class="replies">
          ...
          <div class="reply-box" v-if="showReply">
            ...
            <quill-editor v-model="replyContent" ref="myQuillEditor" :options="editorOption">
            </quill-editor>
      ...
      <div class="right">
        ...
        <div class="share-class">
          <img onclick="_hmt.push(['_trackEvent','zhufeng', 'advs', 'click']);window.location.href='http://www.zhufengpeixun.cn/main/course/index.html?ref=zb'"
            src="http://static.vue-js.com/FgEKlBDltzGKmDGkAq5zxSxt8kga" alt="">
        </div>
        <div class="banner-img">
          <img src="https://user-images.githubusercontent.com/9276376/27581837-70cf9944-5b61-11e7-8d76-72cfc3856dad.png"
            alt="">
          <img src="https://cloud.githubusercontent.com/assets/9276376/18077980/92747c60-6ebb-11e6-9a6c-e65bfe42d45e.png"
            alt="">
          <img src="https://user-images.githubusercontent.com/9276376/30099651-eb36c06a-9318-11e7-8987-2da1bb2b3e13.png"
            alt="">
          <img src="https://user-images.githubusercontent.com/9276376/30099311-fd5c02f6-9317-11e7-8103-abb77c02fb40.png"
            alt="">
        </div>
        ...
        <div class='club-communication'>
          ...
          <div class="erCode-content">
            ...
            <div class="QQ">
              <img src="https://cloud.githubusercontent.com/assets/9276376/20613626/b317ca38-b300-11e6-940d-33df210cb7ba.png"
                width="130" alt="">
              <span>QQ扫码快速入群</span>
            </div>
          </div>
        ...
        editorOption: {
          modules: {
            toolbar: [
              ['bold', {
                'color': []
              }, 'italic', 'blockquote', 'underline', {
                'list': 'ordered'
              }, {
                'list': 'bullet'
              }, 'link', 'image', 'code-block'] // toggled buttons
            ]
          }
        },
        showReply: sessionStorage.getItem('accesstoken')
      }
    },
    async created() {
      try {
