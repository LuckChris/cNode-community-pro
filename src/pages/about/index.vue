  ...
  <div class='about-page'>
    <div class="content">
      <div class="left-content">
        <div class="top-title">
          <p><router-link to ='/' class='home'>主页</router-link>/ <span>关于</span></p>
        </div>
        <div class="about-content">
          <h3 class="title">关于</h3>
          <p>Vue 中文社区是全球最大的 Vueframework 中文开源技术社区，致力于 Vue 在中国的学习、推广、研究工作。</p>
          <p>Vue 中文社区正在努力建设中，如果你有什么想法，欢迎<a href="https://www.vue-js.com/?tab=bb">吐槽</a></p>
...
<script>
import ContentRight from '../home/home-right'
export default {
  data () {
    return {
